      ...
      <section className="page-pad section-pad">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", maxWidth: "900px" }}>
          ...
          <div style={{ background: "var(--warm-white)", border: "1px solid var(--rule)", padding: "2rem" }}>
            ...
            <p className="t-body-sm" style={{ color: "#777" }}>For now, email us directly at <a href="mailto:jerry@thefledge.com" style={{ color: "var(--ink)" }}>jerry@thefledge.com</a> with a brief description of your project and timeline.</p>
          </div>
        </div>
      </section>
    </>
